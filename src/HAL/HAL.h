...
#pragma once
  ...
  // WeAct BluePill+ GD32F303, 256K flash, ARM Cortex M4 (STM32duino board manager)
  // Work in progress to use the GD32Comunity Board instead STM
